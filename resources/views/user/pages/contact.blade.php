					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-9 address-right text-left">
								<h6>Địa Chỉ</h6>
								<p>182 Lê Duẩn, Bến Thủy, Thành phố Vinh, Nghệ An.
					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-9 address-right text-left">
								<h6>Email</h6>
								<p>
									<a href="mailto:tranvanquyenx4@gmail.com" style="color:#2a8490;line-height: 1.9em;"> admin@gmail.com</a>
									<a href="mailto:tranvanquyenx4@gmail.com" style="color:#2a8490;line-height: 1.9em;"> tranvanquyenx4@gmail.com</a>
								</p>
							</div>
