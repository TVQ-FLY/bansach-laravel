			...
			<div class="row footer-top-w3layouts">
				<div class="col-lg-4 footer-grid-w3ls">
					...
					<div class="footer-text">
						...
						<ul class="footer-social text-left mt-lg-4 mt-3">
							...
							<li class="mx-2">
								<a href="https://www.facebook.com/tranvanquyen.01">
				...
				<div class="col-lg-4 footer-grid-w3ls">
					...
					<div class="contact-info">
						...
						<div class="phone">
							<h4>Liên hệ :</h4>
							<p>Điện thoại : (+84) 368835167</p>
							<p>Email :
								<a href="mailto:tranvanquyenx4@gmail.com">admin@gmail.com</a>
							</p>
						</div>
					</div>
				</div>
